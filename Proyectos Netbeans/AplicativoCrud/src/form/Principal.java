...
public class Principal extends javax.swing.JFrame {
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if (row == -1) {
            ...
            String email = (String) TablaDatos.getValueAt(row, 3);
            txtId.setText("" + id);
            txtDNI.setText(dni);
            txtNom.setText(nom);
...
//            model=new DefaultTableModel(null,Titulos);   
    ...
    void Agregar() {
        ...
        try {
            if (dni.equals("") || nom.equals("")) {
                ...
                String sql = "insert into persona(DNI,Nombres,Email) values('" + dni + "','" + nom + "','" + email + "')";
                con = cn.getConnection();
                st = con.createStatement();
    ...
    void Modificar() {
        ...
        String nom = txtNom.getText();
        String email = txtEmail.getText();
        String sql = "update persona set DNI='" + dni + "',Nombres='" + nom + "',Email='" + email + "' where Id=" + id;
        try {
